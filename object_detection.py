...
class ObjectDetection:
    def __init__(self):
        ...
        # self.COLORS = np.random.uniform(0, 255, size=(len(self.CLASSES), 2))
        ...
        print("self.COLORS: " + str(self.COLORS))
    ...
    def detectObj(self, snap):
        ...
        # print("range(len(boxes)): " + str(range(len(boxes))))

        for i in range(len(boxes)):
            if i in indexes:
                print(
                    "id: " + str(class_ids[i]) + " label: " + str(self.CLASSES[class_ids[i]]))
                x, y, w, h = boxes[i]
...
class VideoStreaming(object):
    ...
    def showVideo(self):
        ...
        self.VIDEO = cv2.VideoCapture("./videos/road_traffic3.mp4")
        while(self.VIDEO.isOpened()):
            ...
            if ret == True:
                ...
                if self._preview:
                    ...
                    cv2.putText(snap, text, (wW, hH * 2), font, 1.5, (50, 170, 50), 2)
